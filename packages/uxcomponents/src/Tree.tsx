...
const itemStyles = tv({
  ...
  variants: {
    isSelected: {
      ...
      true: 'bg-accent-100 dark:bg-accent-700/30 hover:bg-accent-200 pressed:bg-accent-200 dark:hover:bg-accent-700/40 dark:pressed:bg-accent-700/40 border-y-accent-200 dark:border-y-accent-900 z-20'
    },
    isDisabled: {
