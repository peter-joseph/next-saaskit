...
const dropZone = tv({
  ...
  variants: {
    isFocusVisible: {
      true: "outline outline-2 -outline-offset-1 outline-accent-600 dark:outline-accent-500 forced-colors:outline-[Highlight]"
    },
    isDropTarget: {
      true: "bg-accent-200 dark:bg-accent-800 outline outline-2 -outline-offset-1 outline-accent-600 dark:outline-accent-500 forced-colors:outline-[Highlight]",
    }
  }
});
