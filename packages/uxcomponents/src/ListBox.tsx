...
interface ListBoxProps<T> extends Omit<AriaListBoxProps<T>, 'layout' | 'orientation'> {} // eslint-disable-line @typescript-eslint/no-empty-object-type
...
export const itemStyles = tv({
  ...
  variants: {
    isSelected: {
      ...
      true: 'bg-accent-600 text-white forced-colors:bg-[Highlight] forced-colors:text-[HighlightText] [&:has(+[data-selected])]:rounded-b-none [&+[data-selected]]:rounded-t-none -outline-offset-4 outline-white dark:outline-white forced-colors:outline-[HighlightText]'
    },
    isDisabled: {
...
export const dropdownItemStyles = tv({
  ...
  variants: {
    ...
    isFocused: {
      true: 'bg-accent-600 dark:bg-accent-600 text-white forced-colors:bg-[Highlight] forced-colors:text-[HighlightText]'
    }
  },
  compoundVariants: [
    {
